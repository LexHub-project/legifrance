...
Doubs : 4    Nombre de voix de chaque administrateur d'union départementale d'associations familiales :
...
Lot : 1   Nombre de voix de chaque administrateur d'union départementale d'associations familiales :
...
Saône (Haute-) : 3    Nombre de voix de chaque administrateur d'union départementale d'associations familiales :
